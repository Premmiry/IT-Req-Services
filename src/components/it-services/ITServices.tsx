      ...
      case '1':
        return (
          ...
          <Grid container spacing={1} >
            ...
            <Grid item xs={2}>
              {/* <Skeleton loading={loading2} variant="rectangular"> */}
              <FormLabel>Manager Date</FormLabel>
              <Input
                type='date'
                variant="outlined"
                color="success"
            ...
            <Grid item xs={2}>
              {/* <Skeleton loading={loading2} variant="rectangular"> */}
              <FormLabel>Director Status</FormLabel>
              <Select
                action={action}
                value={value4}
                placeholder="Status"
            ...
            <Grid item xs={2}>
              <FormLabel>Director Date</FormLabel>
              <Input
                type='date'
                variant="outlined"
                color="warning"
    ...
    <React.Fragment>
      ...
      <Container maxWidth="lg">
        ...
        <Paper sx={{ width: '100%', padding: 2, boxShadow: 10 }}>
          <Grid xs={6} >
            <Box><h2>User Request (All)</h2></Box>
          </Grid>
        ...
        <Paper sx={{ width: '100%', padding: 2, boxShadow: 10 }}>
          <Grid xs={6} >
            <Box><h2>User M/D Request (IT-Request)</h2></Box>
          </Grid>
          <Grid container spacing={2} sx={{ flexGrow: 1 }}>
