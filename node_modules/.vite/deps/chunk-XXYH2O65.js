...
var _excluded3 = ["children", "className", "icon", "optional"];
...
var StepButton = React5.forwardRef(function StepButton2(inProps, ref) {
  ...
  const child = isMuiElement_default(children, ["StepLabel"]) ? React5.cloneElement(children, childProps) : (0, import_jsx_runtime7.jsx)(StepLabel_default, _extends({}, childProps, {
    children
  }));
  return (0, import_jsx_runtime7.jsx)(StepButtonRoot, _extends({
    focusRipple: true,
    disabled,
    TouchRippleProps: {
...
//# sourceMappingURL=chunk-XXYH2O65.js.map
