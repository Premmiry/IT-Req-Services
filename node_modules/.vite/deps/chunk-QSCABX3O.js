...
} from "./chunk-7GI6YGFE.js";
import {
  useButton
} from "./chunk-MHJZ5FZI.js";
import {
  areArraysEqual,
...
function useSelect(props) {
  ...
  const optionValues = React4.useMemo(() => Array.from(options.keys()), [options]);
  const getOptionByValue = React4.useCallback((valueToGet) => {
  ...
  const isItemDisabled = React4.useCallback((valueToCheck) => {
    const option = getOptionByValue(valueToCheck);
    return (option == null ? void 0 : option.disabled) ?? false;
  }, [getOptionByValue]);
  const stringifyOption = React4.useCallback((valueToCheck) => {
    const option = getOptionByValue(valueToCheck);
    if (!option) {
      return "";
    }
  ...
  const controlledState = React4.useMemo(() => ({
    selectedValues: value,
    open: openProp
  }), [value, openProp]);
  const getItemId = React4.useCallback((itemValue) => {
    var _a;
    return (_a = options.get(itemValue)) == null ? void 0 : _a.id;
  }, [options]);
  const handleSelectionChange = React4.useCallback((event, newValues) => {
    if (multiple) {
  ...
  const handleHighlightChange = React4.useCallback((event, newValue) => {
    onHighlightChange == null ? void 0 : onHighlightChange(event, newValue ?? null);
  }, [onHighlightChange]);
  const handleStateChange = React4.useCallback((event, field, fieldValue) => {
    var _a;
    if (field === "open") {
  ...
  const getItemDomElement = React4.useCallback((itemId) => {
    var _a;
    if (itemId == null) {
      return null;
    }
  ...
  const useListParameters = {
    ...
    reducerActionContext: React4.useMemo(() => ({
      multiple
    }), [multiple]),
    items: optionValues,
  ...
  const isInitiallyOpen = React4.useRef(open);
  useEnhancedEffect_default(() => {
    var _a;
  ...
  const getOptionMetadata = React4.useCallback((optionValue) => getOptionByValue(optionValue), [getOptionByValue]);
  ...
  const contextValue = React4.useMemo(() => _extends({}, listContextValue, compoundComponentContextValue), [listContextValue, compoundComponentContextValue]);
  let selectValue;
  if (props.multiple) {
...
function SelectProvider(props) {
  ...
  const listContextValue = React5.useMemo(() => ({
    dispatch,
    getItemState,
    getItemIndex
...
function useTabs(parameters) {
  ...
  const onSelected = React7.useCallback((event, newValue) => {
    setValue(newValue);
  ...
  const tabIdLookup = React7.useRef(() => void 0);
  const getTabPanelId = React7.useCallback((tabValue) => {
    var _a;
    return (_a = tabPanels.get(tabValue)) == null ? void 0 : _a.id;
  }, [tabPanels]);
  const getTabId = React7.useCallback((tabPanelId) => {
    return tabIdLookup.current(tabPanelId);
  }, []);
  const registerTabIdLookup = React7.useCallback((lookupFunction) => {
...
function TabsProvider(props) {
  ...
  const compoundComponentContextValue = React9.useMemo(() => ({
    getItemIndex,
    registerItem,
    totalSubitemCount
  }), [registerItem, getItemIndex, totalSubitemCount]);
  const tabsContextValue = React9.useMemo(() => ({
    direction,
    getTabId,
    getTabPanelId,
    onSelected,
  ...
  return (0, import_jsx_runtime4.jsx)(CompoundComponentContext.Provider, {
    value: compoundComponentContextValue,
    children: (0, import_jsx_runtime4.jsx)(TabsContext.Provider, {
...
var Tabs = React10.forwardRef(function Tabs2(props, forwardedRef) {
  const {
    children,
    orientation = "horizontal",
    direction = "ltr",
...
true ? Tabs.propTypes = {
   ...
   */
  defaultValue: import_prop_types3.default.oneOfType([import_prop_types3.default.number, import_prop_types3.default.string]),
  /**
...
function useTabsList(parameters) {
  ...
  const tabIdLookup = React11.useCallback((tabValue) => {
    var _a;
    return (_a = subitems.get(tabValue)) == null ? void 0 : _a.id;
  }, [subitems]);
  registerTabIdLookup(tabIdLookup);
  const subitemKeys = React11.useMemo(() => Array.from(subitems.keys()), [subitems]);
  const getTabElement = React11.useCallback((tabValue) => {
    var _a;
    if (tabValue == null) {
      return null;
    }
  ...
  const handleChange = React11.useCallback((event, newValue) => {
    onSelected(event, newValue[0] ?? null);
  }, [onSelected]);
  const controlledProps = React11.useMemo(() => {
    if (value === void 0) {
      return {};
    }
    return value != null ? {
  ...
  const isItemDisabled = React11.useCallback((item) => {
    var _a;
  ...
  const {
    ...
    reducerActionContext: React11.useMemo(() => ({
  ...
  const contextValue = React11.useMemo(() => _extends({}, compoundComponentContextValue, listContextValue), [compoundComponentContextValue, listContextValue]);
  return {
    contextValue,
    dispatch,
    getRootProps,
...
function TabsListProvider(props) {
  ...
  const listContextValue = React12.useMemo(() => ({
    dispatch,
    getItemState,
    getItemIndex
  }), [dispatch, getItemIndex, getItemState]);
  const compoundComponentContextValue = React12.useMemo(() => ({
    getItemIndex,
    registerItem,
    totalSubitemCount
  }), [registerItem, getItemIndex, totalSubitemCount]);
...
function useTab(parameters) {
  ...
  const tabRef = React13.useRef(null);
  ...
  const tabMetadata = React13.useMemo(() => ({
    disabled,
    ref: tabRef,
    id
  }), [disabled, tabRef, id]);
...
function ClickAwayListener(props) {
  ...
  return (0, import_jsx_runtime9.jsx)(React16.Fragment, {
...
function CssAnimation(props) {
  ...
  const hasExited = React55.useRef(true);
  React55.useEffect(() => {
    if (requestedEnter && hasExited.current) {
      hasExited.current = false;
    }
  }, [requestedEnter]);
  const handleAnimationEnd = React55.useCallback((event) => {
...
var CssTransition = React56.forwardRef(function CssTransition2(props, forwardedRef) {
  const {
    children,
    className,
  ...
  const [isEntering, setIsEntering] = React56.useState(false);
  React56.useEffect(() => {
    if (requestedEnter) {
  ...
  const handleTransitionEnd = React56.useCallback((event) => {
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-QSCABX3O.js.map
