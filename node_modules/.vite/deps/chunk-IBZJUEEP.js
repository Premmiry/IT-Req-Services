    ...
    children: [React23.cloneElement(children, childrenProps), (0, import_jsx_runtime29.jsx)(PopperComponent, _extends({
      ...
      children: ({
        ...
        children: (0, import_jsx_runtime30.jsxs)(TooltipComponent, _extends({}, tooltipProps, {
          children: [title, arrow ? (0, import_jsx_runtime29.jsx)(ArrowComponent, _extends({}, tooltipArrowProps, {
            ref: setArrowRef
          })) : null]
        }))
      }))
...
var Tablelvl2Context = React25.createContext();
if (true) {
...
var TableCell = React26.forwardRef(function TableCell2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiTableCell"
  });
  ...
  return (0, import_jsx_runtime31.jsx)(TableCellRoot, _extends({
    as: component,
    ref,
    className: clsx_default(classes.root, className),
    "aria-sort": ariaSort,
...
//# sourceMappingURL=chunk-IBZJUEEP.js.map
