...
function isMuiElement2(element, muiNames) {
  var _a, _b, _c;
  return React31.isValidElement(element) && muiNames.indexOf(
  ...
  const Grid2 = React32.forwardRef(function Grid3(inProps, ref) {
    ...
    return (0, import_jsx_runtime12.jsx)(GridRoot, {
      ...
      children: React32.Children.map(children, (child) => {
        var _a;
        if (React32.isValidElement(child) && isMuiElement2(child, ["Grid"]) && container && child.props.container) {
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-IJOUJVSV.js.map
